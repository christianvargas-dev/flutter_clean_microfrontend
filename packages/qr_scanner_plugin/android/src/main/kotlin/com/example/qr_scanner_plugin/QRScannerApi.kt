...
data class QRResult (
 ...
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): QRResult {
...
interface QRScannerApi {
  fun scanQRCode(callback: (Result<QRResult>) -> Unit)
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: QRScannerApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.qr_scanner_plugin.QRScannerApi.scanQRCode$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            api.scanQRCode{ result: Result<QRResult> ->
